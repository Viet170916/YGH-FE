...
export const onloadAnimation = controls => {
...
export const animateOverlayIn = ( overlay, navbar, setExpandingState ) => {
...
export const animateOverlayOut = ( overlay, navbar, callback ) => {
  const tl = gsap.timeline( {
                              onComplete: () => {
...
export const animateImg = ( overlay, callback, navbar ) => {
  const tl = gsap.timeline( {
...
export const animatePreview = ( x, slideCount, numberTransform, images: Image[]|undefined ) => {
  ...
  .set( ".slider-container", {
    background: `url('${ images?.[slideCount].url }') center center / cover`,
  } )
